...
class openList(Queue):
    ...
    def extend(self, items):
        self.A.extend(items)
        #Creamos una función lambda que tratará cada uno de los nodos del vector (que ahora mismo se llamarán X. Lo que
        #hará el método es devolver el path_cost de cada uno de los elementos y ordenar según este valor.
